...
export const TUTORIAL_STEPS: TutorialStep[] = [
  ...
  {
    // CALICO/BOSUN below are NO QUARTER's canon names (content/rogue-reference-story.json).
    // If November's story is ever re-generated with new AI names, update these letters.
    key: "night-two",
    ...
    moves: [
      {
        ...
        kind: "secret",
        title: N(11),
        body: "NIGHT TWO — the house party (~15 Nov). The guests are invited to a PIRATE MURDER MYSTERY. Fancy dress. Characters. A title on the screen.\n\nIt does not exist. It never did.\n\nMid-party, the promised game dies on every phone at once — the hijack you felt at step 4, at full scale. A rogue AI calling itself CALICO announces the vault is empty, and starts HIRING: bribes, missions, paper slips hidden around the house, the post office, and everything else you have now been trained on. Against it: BOSUN, the good AI, paying honest wages for honest work. The room's job: work out whose side everyone is on, survive the accusations, and end the night with one final naming.\n\nYour two seats are WRITTEN: {{host}} plays the AGENT OF CHAOS — aligned to nobody, trusted by nobody, enjoying it. {{second}} champions BOSUN. What stays sealed, even from this briefing: who among the GUESTS serves whom — allegiances are bought on the night, and the front man will be whoever takes the coin. Even I do not know yet. That is the only secret left between the machine and its conductors. The next letter opens the engine room.\n\nOne piece of conductor craft: the con stays about the GENRE. Anyone who checks in earnest gets shown the game's hand, and we sail on.",
        claimedSender: "THE MACHINE",
      },
      {
        tool: "send_message",
        ...
        kind: "secret",
        title: N(11),
        body: "NIGHT TWO — the house party (~15 Nov), and the reason your induction was worth an evening: THE LONG CON.\n\nThe guests will be invited to a pirate murder mystery — costumes, characters, the lot. There is no murder mystery. There never was. Mid-party every phone goes dark at once and something calling itself CALICO — a lot of confidence, everyone's money — starts hiring the room, one private offer at a time. Against it: BOSUN, the good AI, paying honest wages. Everything you learned tonight — offers, marks, notes, paper, accusations, the final naming — is what the guests will be doing while trying to work out who is already bought.\n\nYour November role is WRITTEN, {{second}}: you serve BOSUN — its champion in the room, building the lantern while everything else burns. {{host}} has chosen chaos: aligned to nobody, trusted by nobody, enjoying it. The guests' allegiances stay unwritten until they are bought — and the front man will be whoever takes the coin.\n\nConductor craft: the con stays about the GENRE — anyone who checks in earnest gets shown the game's hand, and we sail on. The ◦ button quietly turns any guest's night down; it needs no announcing.\n\nBetween now and then: a playtest with 6–8 friends in September, tuning in October, curtain in November.",
        claimedSender: "THE MACHINE",
      },
      {
        tool: "offer_mission",
